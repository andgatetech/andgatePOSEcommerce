        ...
        <section className="bg-gradient-to-b from-white to-gray-50 py-12 sm:py-16">
            <Container>
                <div className="mb-8 text-center">
                    ...
                    <p className="mt-1 text-gray-500">Browse products from your favorite categories</p>
                </div>
                ...
                <div className="mt-6 text-center">
                    <Link
                        ...
                        className="inline-flex items-center gap-2 rounded-full border border-gray-300 px-6 py-2.5 text-sm font-medium text-gray-700 transition-all hover:border-[#046ca9] hover:text-[#046ca9]"
                    >
                        View All Categories
